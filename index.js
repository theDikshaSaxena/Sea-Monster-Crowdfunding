...
const unfundedGamesMessage = `A total of ${totalRaised.toLocaleString()} has been raised for ${fundedGamesCount} ${fundedGames.length === 1 ? 'game' : 'games'}. We currently have ${unfundedGamesCount} ${unfundedGamesCount === 1 ? 'unfunded game' : 'unfunded games'} on our platform. Please help us fund these games!`;
